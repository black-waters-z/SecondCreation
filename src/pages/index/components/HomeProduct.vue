<template>
  ...
  <view class="w-100 relative">
    <Arrow
      class="scroll-view-container__left-arrow"
      @click="goToLeft"
      v-show="!stopScrollLeft"
    ></Arrow>
    <Arrow
      class="scroll-view-container__right-arrow"
      @click="goToRight"
      v-show="!stopScrollRight"
    ></Arrow>
    <scroll-view
      ref="scrollView"
    ...
    >
      <Product
        ...
        class="scroll-view-container__product"
      ></Product>
    </scroll-view>
  </view>
</template>
